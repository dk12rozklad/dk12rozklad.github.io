...
* На 6 семестр: Методи веб-програмування, Архітектура обчислювальних пристроїв, Перспективні технології проектування мікропроцесорних вузлів радіоелектронної апаратури, Сучасні методи коректного констрюювання програм та інформаційних систем
:::
